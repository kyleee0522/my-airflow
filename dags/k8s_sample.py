...
with DAG(
    ...
    run_python = KubernetesPodOperator(
        ...
        cluster_context='k3s-kyleee0522', # context 를 설정한다. context 가 하나면 설정 안해도 됨
        config_file='/bitnami/airflow/kube-config/config-airflow-kyleee', # kube config 화일을 설정한다.
        namespace="airflow", #  namespace를 설정한다.
